...
class FeedViewController: UIViewController {
    ...
    let feedViewModel: FeedViewOutputProtocol
    ...
    lazy var checkButton = MagicButton(title: "Check", titleColor: .white) { [weak self] in
        ...
        let ifCheckedWord = self?.feedViewModel.check(word: self?.checkTextField.text ?? "")
    ...
    init(feedViewModel: FeedViewOutputProtocol) {
