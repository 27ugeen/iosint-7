    ...
    public static let tableModel = [
        PostSection(posts: [
            Post(title: "Tesla profit surge driven by record car deliveries",
                 author: "Elon Mask",
                 image: FilteredImage.shared.putFilterOnImage(#imageLiteral(resourceName: "tesla-model_y"), .noir),
            ...
            Post(title: "The Suicide Squad: James Gunn taps into DC lore with new trailer starring Idris Elba, Margot Robbie, John Cena",
                 author: "James Gunn",
                 image: FilteredImage.shared.putFilterOnImage(#imageLiteral(resourceName: "Margot_Robbie"), .fade),
            ...
            Post(title: "SpaceX lifts huge Super Heavy rocket onto launch stand",
                 author: "Elon Mask",
                 image: FilteredImage.shared.putFilterOnImage(#imageLiteral(resourceName: "Super_heavy_rocket"), .colorInvert),
            ...
            Post(title: "BMW M3 Competition Takes on the Alfa Romeo Giulia Quadrifoglio Again",
                 ...
                 image: FilteredImage.shared.putFilterOnImage(#imageLiteral(resourceName: "G80-BMW-M3-vs-Alfa-Romeo-Giulia-Quadrifoglio-4-of-4"), .bloom(intensity: 1.2)),
